...
export function BotonEditarClientePedido({ cliente }: { cliente: ClientePedido }) {
    ...
    useEffect(() => {
        if (cliente && open) {
            setForm({
                ...
                agenciaOtro: cliente.agenciaOtro || "",
                guiaRemision: cliente.guiaRemision,
    ...
    const buscarPorDocumento = async () => {
        ...
        try {
            ...
            if (json.success) {
                ...
                setForm(prev => ({
                    ...prev,
                    nombre: (form.tipoDoc === "ruc" ? (json.razonSocial || prev.nombre) : (json.nombre || prev.nombre)),
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch(`/api/clientes-pedido/${cliente.id}`, {
                method: "PATCH",
                headers: { "Content-Type": "application/json" },
